...
import { BarChart, Activity, Users, Boxes,RulerDimensionLine } from "lucide-react";
  ...
  return (
    <div className="bg-gradient-to-br from-blue-700 to-indigo-900 min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        ...
        {/* botón Metricas POO */}
        <button
          onClick={() => router.push("/poo")}
          className="group bg-white/10 hover:bg-yellow-600 transition-all duration-300 rounded-2xl p-8 flex flex-col items-center justify-center shadow-lg hover:shadow-green-500/30"
        >
          ...
          <h2 className="text-white text-2xl font-bold">Metricas POO</h2>
          <p className="text-blue-200 group-hover:text-blue-100 mt-2">
          Cohesión, Acoplamiento y Complejidad
          </p>
        </button>
      </div>
        {/* botón Metricas de madurez */}
        <div className="grid grid-cols-1 gap-8  max-w-4xl w-full mt-10">
        <button
          onClick={() => router.push("/madurez")}
          className="group bg-white/10 hover:bg-purple-600 transition-all duration-300 rounded-2xl p-8 flex flex-col items-center justify-center shadow-lg hover:shadow-green-500/30"
        >
          <div className="bg-purple-600/20 group-hover:bg-white/20 p-4 rounded-full mb-4">
            <RulerDimensionLine
              size={40}
          ...
          <h2 className="text-white text-2xl font-bold">Índice de Madurez</h2>
          <p className="text-blue-200 group-hover:text-blue-100 mt-2">
